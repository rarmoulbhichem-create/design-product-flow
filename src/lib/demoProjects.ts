...
export function getDemoProject(template: LandingTemplate): GeneratedProject {
  switch (template) {
    ...
    case "fashion":
      return createDemoProject({
        template: "fashion",
        productImageUrl: "/demos/robe-velours.jpg",
    ...
    case "tech":
      return createDemoProject({
        template: "tech",
        productImageUrl: "/demos/earpods-pro.jpg",
    ...
    case "flashsale":
      return createDemoProject({
        template: "flashsale",
        productImageUrl: "/demos/robot-cuisine.jpg",
    ...
    case "neon":
      return createDemoProject({
        template: "neon",
        productImageUrl: "/demos/manette-rgb.jpg",
    ...
    case "editorial":
      return createDemoProject({
        template: "editorial",
        productImageUrl: "/demos/carnet-cuir.jpg",
